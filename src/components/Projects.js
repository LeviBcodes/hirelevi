    ...
    <div name='projects' className='w-full md:h-screen bg-transparent text-gray-300 px-4'>
        <div className='max-w-[1000px] mx-auto flex py-20 md:py-4 flex-col justify-center w-full h-full'>
            ...
            <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
                <AnimatePresence>
                    <motion.div style={{backgroundImage: `url(${Moviedeets})`}} className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div group-hover:opacity-50'>
                        {/* Hover effects */}
